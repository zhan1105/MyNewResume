...
class AppField: UIView {
    ...
    init(placeholder: LocalizedStringKey.KeyOptions = .shared(.none)){
    ...
    private func setupUI(placeholder: LocalizedStringKey.KeyOptions){
        ...
        // 設定 TextField
        newTextField.placeholder = .localizedString(for: placeholder)
